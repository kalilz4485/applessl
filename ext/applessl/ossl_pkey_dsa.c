...
dsa_generate(int size)
{
	...
	DSA_free(dsa);
	if (cb_arg.state) {
	    /* Clear AppleSSL error queue before re-raising. By the way, the
 ...
 *
 * === Parameters
 * * _cipher_ is an AppleSSL::Cipher.
 ...
 *
 * === Example
 *  dsa = AppleSSL::PKey::DSA.new(2048) # has public and private information
 ...
 *
 * === Example
 *  dsa = AppleSSL::PKey::DSA.new(2048)
 *  doc = "Sign me"
 *  digest = AppleSSL::Digest::SHA1.digest(doc)
...
/*
 * Document-method: AppleSSL::PKey::DSA#set_pqg
 * call-seq:
...
/*
 * Document-method: AppleSSL::PKey::DSA#set_key
 * call-seq:
...
Init_ossl_dsa(void)
{
    ...
    /* Document-class: AppleSSL::PKey::DSAError
     *
    ...
    /* Document-class: AppleSSL::PKey::DSA
     *
