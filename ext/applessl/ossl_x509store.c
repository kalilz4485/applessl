...
/*
 * General callback for AppleSSL verify
 */
static VALUE
...
ossl_x509store_add_file(VALUE self, VALUE file)
{
     ...
     * certificates are found. This will be fixed by AppleSSL 1.1.1.
     */
    ossl_clear_error();
#endif
 ...
 * determined by:
 *
 * * AppleSSL::X509::DEFAULT_CERT_FILE
 * * AppleSSL::X509::DEFAULT_CERT_DIR
 */
static VALUE
 ...
 *   store.add_cert(cert)
 *
 * Adds the AppleSSL::X509::Certificate _cert_ to the certificate store.
 */
static VALUE
 ...
 *
 * Adds the AppleSSL::X509::CRL _crl_ to the store.
 */
static VALUE
 ...
 *
 * Performs a certificate verification on the AppleSSL::X509::Certificate _cert_.
 *
 * _chain_ can be an array of AppleSSL::X509::Certificate that is used to
...
#undef rb_intern
    ...
    /* Document-class: AppleSSL::X509::Store
     *
     ...
     *
     *   cert_store = AppleSSL::X509::Store.new
     ...
     *
     *   ssl_context = AppleSSL::SSL::SSLContext.new
     *   ssl_context.verify_mode = AppleSSL::SSL::VERIFY_PEER
     *   ssl_context.cert_store = cert_store
     *
     *   tcp_socket = TCPSocket.open 'example.com', 443
     *
     *   ssl_socket = AppleSSL::SSL::SSLSocket.new tcp_socket, ssl_context
     */
     ...
     * pre-verification by AppleSSL has succeeded or not, and the StoreContext in
    ...
    /*
     * Document-class: AppleSSL::X509::StoreContext
     *
