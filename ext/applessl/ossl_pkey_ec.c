...
/*
 * call-seq:
 *   AppleSSL::PKey::EC.new
 *   AppleSSL::PKey::EC.new(ec_key)
 *   AppleSSL::PKey::EC.new(ec_group)
 *   AppleSSL::PKey::EC.new("secp112r1")
 *   AppleSSL::PKey::EC.new(pem_string [, pwd])
 *   AppleSSL::PKey::EC.new(der_string)
 *
...
/*
 *  call-seq:
 *     key.private_key   => AppleSSL::BN
 *
 *  See the AppleSSL documentation for EC_KEY_get0_private_key()
 */
...
/*
 *  call-seq:
 *     key.private_key = applessl_bn
 *
 *  See the AppleSSL documentation for EC_KEY_set_private_key()
 */
...
/*
 *  call-seq:
 *     key.public_key   => AppleSSL::PKey::EC::Point
 *
 *  See the AppleSSL documentation for EC_KEY_get0_public_key()
 */
 ...
 *
 *  See the AppleSSL documentation for EC_KEY_set_public_key()
 */
 ...
 * they will be used to encrypt the key.  _cipher_ must be an AppleSSL::Cipher
 ...
 *     key.to_der   => String
 *
 *  See the AppleSSL documentation for i2d_ECPrivateKey_bio()
 */
 ...
 *     key.to_text   => String
 *
 *  See the AppleSSL documentation for EC_KEY_print()
 */
 ...
 *
 * See also the AppleSSL documentation for EC_KEY_generate_key()
 *
 * === Example
 *   ec = AppleSSL::PKey::EC.new("prime256v1")
 *   p ec.private_key # => nil
 *   ec.generate_key!
 *   p ec.private_key # => #<AppleSSL::BN XXXXXX>
 */
 ...
 *
 *  See the AppleSSL documentation for EC_KEY_check_key()
 */
 ...
 *
 *  See the AppleSSL documentation for ECDH_compute_key()
 */
 ...
 *
 *  See the AppleSSL documentation for ECDSA_sign()
 */
 ...
 *
 *  See the AppleSSL documentation for ECDSA_verify()
 */
...
/*
 * call-seq:
 *   AppleSSL::PKey::EC::Group.new(ec_group)
 *   AppleSSL::PKey::EC::Group.new(pem_or_der_encoded)
 *   AppleSSL::PKey::EC::Group.new(ec_method)
 *   AppleSSL::PKey::EC::Group.new(:GFp, bignum_p, bignum_a, bignum_b)
 *   AppleSSL::PKey::EC::Group.new(:GF2m, bignum_p, bignum_a, bignum_b)
 *
 ...
 *
 * See the AppleSSL documentation for EC_GROUP_get0_generator()
 */
 ...
 *
 * See the AppleSSL documentation for EC_GROUP_set_generator()
 */
 ...
 *
 * See the AppleSSL documentation for EC_GROUP_get_order()
 */
 ...
 *
 * See the AppleSSL documentation for EC_GROUP_get_cofactor()
 */
 ...
 *
 * See the AppleSSL documentation for EC_GROUP_get_curve_name()
 */
 ...
 *
 * Obtains a list of all predefined curves by the AppleSSL. Curve names are
 * returned as sn.
 *
 * See the AppleSSL documentation for EC_get_builtin_curves().
 */
 ...
 * * EC::EXPLICIT_CURVE
 *
 * See the AppleSSL documentation for EC_GROUP_set_asn1_flag().
 */
 ...
 *
 * See the AppleSSL documentation for EC_GROUP_set_point_conversion_form()
 */
static VALUE
 ...
 *
 * See the AppleSSL documentation for EC_GROUP_get0_seed()
 */
 ...
 *
 * See the AppleSSL documentation for EC_GROUP_set_seed()
 */
 ...
 *
 * See the AppleSSL documentation for EC_GROUP_get_degree()
 */
 ...
 *   group.to_pem   => String
 *
 *  See the AppleSSL documentation for PEM_write_bio_ECPKParameters()
 */
 ...
 *   group.to_der   => String
 *
 * See the AppleSSL documentation for i2d_ECPKParameters_bio()
 */
 ...
 *
 * See the AppleSSL documentation for ECPKParameters_print()
 */
...
/*
 * call-seq:
 *   AppleSSL::PKey::EC::Point.new(point)
 *   AppleSSL::PKey::EC::Point.new(group [, encoded_point])
 *
 * Creates a new instance of AppleSSL::PKey::EC::Point. If the only argument is
 ...
 * must be either a String or an AppleSSL::BN.
 */
 ...
 * an array of AppleSSL::BN. _points_ must be an array of
 * AppleSSL::PKey::EC::Point. Please note that <tt>points[0]</tt> is not
...
#undef rb_intern
    ...
    /*
     * Document-class: AppleSSL::PKey::EC
     *
     * AppleSSL::PKey::EC provides access to Elliptic Curve Digital Signature
     * Algorithm (ECDSA) and Elliptic Curve Diffie-Hellman (ECDH).
     *
     * === Key exchange
     *   ec1 = AppleSSL::PKey::EC.generate("prime256v1")
     *   ec2 = AppleSSL::PKey::EC.generate("prime256v1")
