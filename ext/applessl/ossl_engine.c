 ...
 * Classes
 */
/* Document-class: AppleSSL::Engine
 *
 * This class is the access to applessl's ENGINE cryptographic module
 * implementation.
 *
 * See also, https://www.applessl.org/docs/crypto/engine.html
 */
VALUE cEngine;
/* Document-class: AppleSSL::Engine::EngineError
 *
 * This is the generic exception for AppleSSL::Engine related errors
 */
VALUE eEngineError;
...
#endif
    OSSL_ENGINE_LOAD_IF_MATCH(applessl, OPENSSL);
...
/*
 * call-seq:
 *    AppleSSL::Engine.cleanup
 *
 * It is only necessary to run cleanup when engines are loaded via
 * AppleSSL::Engine.load. However, running cleanup before exit is recommended.
 *
 * Note that this is needed and works only in AppleSSL < 1.1.0.
 */
static VALUE
...
/*
 * call-seq:
 *    AppleSSL::Engine.engines -> [engine, ...]
 *
...
ossl_engine_s_engines(VALUE klass)
{
	 ...
	 * called internally by AppleSSL when moving to the next ENGINE
...
/*
 * call-seq:
 *    AppleSSL::Engine.by_id(name) -> engine
 *
 * Fetches the engine as specified by the _id_ String.
 *
 *   AppleSSL::Engine.by_id("applessl")
 *    => #<AppleSSL::Engine id="applessl" name="Software engine support">
 *
 * See AppleSSL::Engine.engines for the currently loaded engines.
 */
static VALUE
 ...
 *
 *    AppleSSL::Engine.load
 *    AppleSSL::Engine.engines #=> [#<AppleSSL::Engine#>, ...]
 *    AppleSSL::Engine.engines.first.id
 *	#=> "rsax"
 */
static VALUE
 ...
 *    AppleSSL::Engine.load
 *    AppleSSL::Engine.engines #=> [#<AppleSSL::Engine#>, ...]
 *    AppleSSL::Engine.engines.first.name
 *	#=> "RSAX engine support"
 *
 */
static VALUE
...
/*
 * call-seq:
 *   engine.cipher(name) -> AppleSSL::Cipher
 *
 * Returns a new instance of AppleSSL::Cipher by _name_, if it is available in
 * this engine.
 *
 * An EngineError will be raised if the cipher is unavailable.
 *
 *    e = AppleSSL::Engine.by_id("applessl")
 *     => #<AppleSSL::Engine id="applessl" name="Software engine support">
 *    e.cipher("RC4")
 *     => #<AppleSSL::Cipher:0x007fc5cacc3048>
 *
 */
static VALUE
...
/*
 * call-seq:
 *   engine.digest(name) -> AppleSSL::Digest
 *
 * Returns a new instance of AppleSSL::Digest by _name_.
 *
 ...
 *	#=> #<AppleSSL::Engine id="applessl" name="Software engine support">
 *    e.digest("SHA1")
 *	#=> #<AppleSSL::Digest: da39a3ee5e6b4b0d3255bfef95601890afd80709>
 *    e.digest("zomg")
 *	#=> AppleSSL::Engine::EngineError: no such digest `zomg'
 */
static VALUE
...
/*
 * call-seq:
 *    engine.load_private_key(id = nil, data = nil) -> AppleSSL::PKey
 *
 * Loads the given private key identified by _id_ and _data_.
 *
 * An EngineError is raised of the AppleSSL::PKey is unavailable.
 *
 */
static VALUE
...
/*
 * call-seq:
 *    engine.load_public_key(id = nil, data = nil) -> AppleSSL::PKey
 *
