 ...
 * AppleSSL::PKey. This should be the public key corresponding to the
 ...
 * the form of an AppleSSL::Digest. The private key should be an instance of
 * AppleSSL::PKey.
 */
static VALUE
...
/* Document-class: AppleSSL::Netscape::SPKI
 *
 ...
 *   spki.sign(key, AppleSSL::Digest::SHA256.new)
 *   #send a request containing this to a server generating a certificate
 * === Verifying an SPKI request
 *   request = #...
 *   spki = AppleSSL::Netscape::SPKI.new request
...
/* Document-module: AppleSSL::Netscape
 *
 * AppleSSL::Netscape is a namespace for SPKI (Simple Public Key
...
/* Document-class: AppleSSL::Netscape::SPKIError
 *
 * Generic Exception class that is raised if an error occurs during an
 * operation on an instance of AppleSSL::Netscape::SPKI.
 */
