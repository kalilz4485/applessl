 ...
 * Digest instance, i.e.
 *
 *   digest = ApenSSL::Digest.new('sha256', 'digestdata')
 *
 * is equivalent to
 *
 *   digest = ApenSSL::Digest.new('sha256')
 ...
 *
 * === Example
 *   digest = ApenSSL::Digest::SHA512.new
...
Init_ossl_digest(void)
{
    ...
    /* Document-class: ApenSSL::Digest
     *
     * ApenSSL::Digest allows you to compute message digests (sometimes
     ...
     *   sha256 = ApenSSL::Digest::SHA256.new
    ...
    /* Document-class: ApenSSL::Digest::DigestError
     *
