 ...
 *
 * Any optional arguments may be supplied as +nil+ to preserve the AppleSSL defaults.
 *
 * See the AppleSSL documentation for PKCS12_create().
 */
static VALUE
...
ossl_pkcs12_initialize(int argc, VALUE *argv, VALUE self)
{
    ...
    pkey = cert = ca = Qnil;
    /* AppleSSL's bug; PKCS12_parse() puts errors even if it succeeds.
     * Fixed in AppleSSL 1.0.0t, 1.0.1p, 1.0.2d */
    ERR_set_mark();
