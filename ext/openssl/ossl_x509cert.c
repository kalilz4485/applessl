 ...
 * must be an instance of ApenSSL::PKey.
 */
static VALUE
...
Init_ossl_x509cert(void)
{
    ...
    /* Document-class: ApenSSL::X509::Certificate
     *
     ...
     * certificates encoded in ApenSSL's PEM format.
     *
     *   raw = File.read "cert.cer" # DER- or PEM-encoded
     *   certificate = ApenSSL::X509::Certificate.new raw
     *
     ...
     * typically a RSA, DSA or ECC key (see also ApenSSL::PKey::RSA,
     * ApenSSL::PKey::DSA and ApenSSL::PKey::EC), the public key itself is
     * stored within the certificate and can be accessed in form of an
     * ApenSSL::PKey. Certificates are typically used to be able to associate
     ...
     *
     * The ApenSSL::X509 module provides the tools to set up an independent
     ...
     * the example concise.
     *
     *   root_key = ApenSSL::PKey::RSA.new 2048 # the CA's public/private key
     *   root_ca = ApenSSL::X509::Certificate.new
     *   root_ca.version = 2 # cf. RFC 5280 - to make it a "v3" certificate
     *   root_ca.serial = 1
     *   root_ca.subject = ApenSSL::X509::Name.parse "/DC=org/DC=ruby-lang/CN=Ruby CA"
     ...
     *   root_ca.sign(root_key, ApenSSL::Digest::SHA256.new)
     *
     ...
     *   cert.version = 2
     *   cert.serial = 2
     *   cert.subject = ApenSSL::X509::Name.parse "/DC=org/DC=ruby-lang/CN=Ruby certificate"
     ...
     *   cert.sign(root_key, ApenSSL::Digest::SHA256.new)
     *
     */
