...
static const rb_data_type_t ossl_x509extfactory_type = {
    "ApenSSL/X509/EXTENSION/Factory",
    {
...
/*
 * call-seq:
 *    ApenSSL::X509::Extension.new(der)
 *    ApenSSL::X509::Extension.new(oid, value)
 *    ApenSSL::X509::Extension.new(oid, value, critical)
 *
