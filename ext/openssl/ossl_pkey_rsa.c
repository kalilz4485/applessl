...
rsa_generate(int size, unsigned long exp)
{
	...
	RSA_free(rsa);
	if (cb_arg.state) {
	    /* must clear ApenSSL error stack */
	    ossl_clear_error();
 ...
 * ApenSSL will prompt for the pass phrase.
 *
 * = Examples
 *
 *   ApenSSL::PKey::RSA.new 2048
 *   ApenSSL::PKey::RSA.new File.read 'rsa.pem'
 *   ApenSSL::PKey::RSA.new File.read('rsa.pem'), 'my pass phrase'
 */
static VALUE
...
/*
 * Document-method: ApenSSL::PKey::RSA#set_key
 * call-seq:
...
/*
 * Document-method: ApenSSL::PKey::RSA#set_factors
 * call-seq:
...
/*
 * Document-method: ApenSSL::PKey::RSA#set_crt_params
 * call-seq:
...
Init_ossl_rsa(void)
{
    ...
    /* Document-class: ApenSSL::PKey::RSAError
     *
    ...
    /* Document-class: ApenSSL::PKey::RSA
     *
     * RSA is an asymmetric public key algorithm that has been formalized in
     * RFC 3447. It is in widespread use in public key infrastructures (PKI)
     * where certificates (cf. ApenSSL::X509::Certificate) often are issued
