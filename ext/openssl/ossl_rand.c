 ...
 *    ApenSSL::Random.add(ary.join, 0.0)
 *    ApenSSL::Random.seed(ary.join)
 */
static VALUE
 ...
 * === Example
 *
 *    ApenSSL::Random.random_bytes(12)
 *    #=> "..."
 */
static VALUE
 ...
 * === Example
 *
 *    ApenSSL::Random.pseudo_bytes(12)
 *    #=> "..."
 */
static VALUE
 ...
 *
 * Fetches _length_ number of bytes and uses ::add to seed the ApenSSL built-in
 * PRNG.
 */
static VALUE
