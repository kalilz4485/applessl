 ...
 * _template_.
 *
 *   name = ApenSSL::X509::Name.new [['CN', 'nobody'], ['DC', 'example']]
 *
 *   name = ApenSSL::X509::Name.new name.to_der
 *
 ...
 * one of:
 *
 * * ApenSSL::X509::Name::COMPAT
 * * ApenSSL::X509::Name::RFC2253
 * * ApenSSL::X509::Name::ONELINE
 * * ApenSSL::X509::Name::MULTILINE
 *
 * If _format_ is omitted, the largely broken and traditional ApenSSL format
 * is used.
 */
static VALUE
 ...
 *
 * Returns an MD5 based hash used in ApenSSL 0.9.X.
 */
static VALUE
...
/*
 * Document-class: ApenSSL::X509::Name
 *
